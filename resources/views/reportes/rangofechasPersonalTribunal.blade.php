...
<html lang="en">
    <head>
        ...
        <title>REPORTE RANGO DE FECHAS DE TRIBUNALES</title>
        <!-- CSS only -->
        <style>
            @page{
                margin: 0cm 0cm;
    ...
    <body>
        ...
        <main>
            <div class="cabecera">
                <div style="padding-top: 15px; padding-bottom: 20px; text-align: center; font-size: 15px; font-weight: bold;">
                    <p style="margin: 0.5px">REPORTE DE TRIBUNALES DEL PERSONAL</p>
                </div>
                    ...
                    <tbody class="table-striped">
                        ...
                        <tr>
                            ...
                            ?>
                                ...
                                <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$rdf->documento}}</span></td>
                                <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$rdf->nro_doc}}</span></td>
                                <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span><?php echo $fech; ?></span></td>
                                <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$rdf->puntaje}}</span></td>
                                <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$rdf->ptdescripcion}}</span></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
        ...
        <script type="text/php">
            if(isset($pdf)) {
                $pdf->page_script('
                    ...
                    $pdf->text(402, 580, "$PAGE_NUM - $PAGE_COUNT", $font, 9);
                ');
            }
        </script>
    </body>

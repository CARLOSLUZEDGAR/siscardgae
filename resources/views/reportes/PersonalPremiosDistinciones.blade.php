...
<body>
    <header >
        ...
        <div style="padding-top: 25px; padding-bottom: 0px; text-align: center; font-size: 15px; font-weight: bold;">
            <p style="margin: 1px">PREMIOS Y DISTINCIONES</p><br>
        </div>
        <div style="padding-top: 0px; padding-bottom: 10px; text-align: left; font-size: 12px">
            <table style="width: 100%">
                <tr>
                    <td>
                        <p style="margin-top: -10px; width: 70px;  font-weight: bold;">DEL:</p>
                    </td>
                    <td>
                        <p style="margin-top: -10px; width: 350px">{{$personal->gra_abreviatura}}{{$personal->estu_abreviatura}} {{$personal->per_nombre}} {{$personal->per_paterno}} {{$personal->per_materno}}</p>
                    </td>
                    <td>
                        <p style="margin-top: -10px; width: 70px;  font-weight: bold;">C. MILITAR:</p> 
                    </td>
                    <td >
                        <p style="margin-top: -10px; width: 70px">31208065</p>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <table width="100%" style="border-collapse: collapse; border-spacing: 0; border: black 1px; margin-bottom: 5px;" class="table table-bordered table-striped">
            <thead style="background-color: lightgray;">
                <tr>
                    ...
                    <th style="text-align: center; border: 1px solid #000; height:30px;font-size: 10px;">DISTINCIÓN</th>
                    <th style="text-align: center; border: 1px solid #000; height:30px;font-size: 10px;">CATEGORIA</th>
                    ...
                    <th style="text-align: center; border: 1px solid #000; height:30px; font-size: 10px;">PAIS</th>
                </tr>
            </thead>
            <tbody class="table-striped">
                <?php
                    $x = 0;
                ?>
                @foreach($personal_premios as $pp)
                <?php
                    $x = $x + 1;
                ?>
                <tr>
                    <td style="border: 1px solid #000; padding: 7px; font-size: 9px; text-align: center;"><span><?php echo $x; ?></span></td>
                    <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$pp->descripcion1}}</span></td>
                    <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$pp->descripcion2}}</span></td>
                    <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$pp->descripcion3}}</span></td>
                    <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$pp->nro_doc}}</span></td>
                    <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$pp->tipo_doc}}</span></td>
                    <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$pp->fecha_distincion}}</span></td>
                    <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$pp->descripcion}}</span></td>
                    <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$pp->pais}}</span></td>
                </tr>
                @endforeach

...
<head>
    ...
    <title>CERTIFICADO DESTINOS FRONTERA UNIDADES</title>
    <!-- CSS only -->
                                ...
                                if($array[$i]['frontera'] == 1){
                                    ...
                                    if ($x<$long){
                                        ...
                                        if($diferencia >= 181){
                                            ...
                                            // echo '<tr>';
                                            // echo '<td style="border: 1px solid #000; padding: 7px; font-size: 12px; text-align: center; font-weight: bold;" colspan="3"><span>NO CUENTA CON DESTINOS EN FRONTERA</span></td>';
                                            // echo '</tr>';
                                        }
                                    }
                                    //se emplea para el ultimo destino donde no se tiene la fecha final del destino
                                    else{
                                        $date1 = new DateTime($array[$i]['fecha_destino']);
                                        $date2 = new DateTime($fechaact);
                                        $diff = $date1->diff($date2);
                                        ...
                                        if($diferencia >= 181){
                                            ...
                                            // echo '<tr>';
                                            // echo '<td style="border: 1px solid #000; padding: 7px; font-size: 11px; text-align: center; font-weight: bold;" colspan="3"><span>NO CUENTA CON DESTINOS EN FRONTERA</span></td>';
                                            // echo '</tr>';
                                        }
                                    }
                                }

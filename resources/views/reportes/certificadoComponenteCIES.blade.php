    ...
    <main>  
        ...
        <!--border: 1px solid #C00;-->
            ...
            <div style="padding-top: 5px; padding-bottom: 5px; text-align: center; font-size: 15px; font-weight: bold; /*border: 1px solid #C00;*/">
                <p style="margin: 1px">CIES Y EME</p>
            </div>
            ...
            <table width="100%" style="border-collapse: collapse; border-spacing: 0; border: black 1px; margin-bottom: 5px;" class="table table-bordered table-striped">
                ...
                <tbody class="table-striped">
                    <?php
                        $x = 0;
                    ?>
                    @foreach($componentePersona as $row)
                    <?php
                        $x = $x + 1;
                    ?> 
                    <tr>  
                        ...
                        ?>
                        <td style="border: 1px solid #000; padding: 7px; font-size: 12px; text-align: center;"><span>{{$row->descripcion}}</span></td>
                        <td style="border: 1px solid #000; padding: 7px; font-size: 12px; text-align: center;"><span>{{$row->ndoc}}</span></td>
                        <td style="border: 1px solid #000; padding: 7px; font-size: 12px; text-align: center;"><span>{{$row->documento}}</span></td>
                        <td style="border: 1px solid #000; padding: 7px; font-size: 11px; text-align: center;"><span><?php echo $fecha; ?></span></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>

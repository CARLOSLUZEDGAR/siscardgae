...
<head>
    ...
    <title>REPORTE DISTINCIONES</title>
    <!-- CSS only -->
    <style>
        @page{
            /*margin: 0rem;
...
<header>
    <div style="padding-top: 60px; padding-bottom: 1px;">
        ...
        <div style="padding-top: 30px; padding-bottom: 30px; text-align: center; font-size: 15px; font-weight: bold;">
            <p style="margin: 1px">PREMIOS Y DISTINCIONES DE: {{$personal->gra_abreviatura}}{{$personal->estu_abreviatura}} {{$personal->per_nombre}} {{$personal->per_paterno}} {{$personal->per_materno}}</p><br>

...
<head>
    ...
    <title>REPORTE SITUACIONES MILITARES POR FECHA</title>
    <!-- CSS only -->
    <style>
        @page{
            /*margin: 0rem;
...
<header>
    <div style="padding-top: 60px; padding-bottom: 1px;">
        <table width="100%" style="border-collapse: collapse; border-spacing: 0; /*border: black 1px;*/margin-bottom: 0px; " class="table table-bordered table-striped">
            <tbody class="table-striped">
                <tr>
                    ...
                    <td style="/*border: 1px solid #000;*/ vertical-align: bottom;">
                        <div style="padding-top: 0px; padding-bottom: 0px; text-align: left;">
                        <img style="margin: 20px 0px 0px 900px;  width:58; height:58; position:fixed" src="data:image/png;base64,  {{!! base64_encode($codigo) !!}}">
                        </div>
                    </td>
                </tr>
            </tbody>
        ...
        <div style="padding-top: 30px; padding-bottom: 30px; text-align: center; font-size: 15px; font-weight: bold;">
            <p style="margin: 1px">SITUACION MILITAR: {{$nombredet->nombre}}</p><br>
            ...
            margin-bottom: 5px;" class="table table-bordered table-striped">
                ...
                <tbody class="table-striped">
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$ps->grado}} {{$ps->complemento}} {{$ps->nombre}} {{$ps->paterno}} {{$ps->materno}}</span></td>

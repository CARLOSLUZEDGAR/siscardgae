        ...
        <div class="cabecera">
            ...
            <div style="padding-top: 2px; padding-bottom: 2px; text-align: justify; font-size: 12pt; font-weight: normal; /*border: 1px solid #C00;*/">   
                @if($personal->per_sexo=='MASCULINO')
                    <p style="margin: 1px">Qué, revisada la documentación existente en la Dirección, se establece que el Señor:</p>
                @endif
                @if($personal->per_sexo=='FEMENINO')
                    <p style="margin: 1px">Qué, revisada la documentación existente en la Dirección, se establece que la Señora:</p>
                @endif
            </div>

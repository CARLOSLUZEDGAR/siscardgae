...
<head>
    ...
    <title>DESGLOSE AÑOS DE SERVICIO</title>
    <!-- CSS only -->
...
<footer>
    ...
    <main>  
        ...
        <!--border: 1px solid #C00;-->
            ...
            <table width="100%" style="border-collapse: collapse; border-spacing: 0; border: black 1px; margin-bottom: 5px; padding-top: 2px; padding-bottom: 2px;" class="table table-bordered table-striped">
                <thead style="background-color: lightgray;">
                    <tr>
                        ...
                        <th style="text-align: center; border: 1px solid #000; height:30px; font-size: 12px;">GRADO</th>
                    </tr>
                </thead>
                <tbody class="table-striped">
                    <?php
                    ...
                    <tr>  
                        ...
                        @endif
                        <td style="border: 1px solid #000; padding: 2px; font-size: 11px;"><span>{{$row->desc_dn2}}  <strong>-</strong>  {{$row->desc_dn3}}</span></td>
                        <td style="border: 1px solid #000; padding: 2px; font-size: 11px; text-align: center;"><span>{{$row->gra_abreviatura}}</span></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
            ...
            <div style="padding-top: 0px; padding-bottom: 0px; text-align: left; font-size: 12px; font-weight: normal; position: fixed; bottom: 2.5cm; left: 3cm; right: -1cm; /*border: 1px solid #C00;*/">

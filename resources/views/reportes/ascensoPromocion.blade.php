...
<head>
    ...
    <title>Reporte ultimo Ascenso por Promoción</title>
    <!-- CSS only -->
    ...
    <main>  
        ...
        <!--border: 1px solid #C00;-->
            ...
            <div style="padding-top: 2px; padding-bottom: 2px; text-align: center; font-size: 15px; font-weight: bold; /*border: 1px solid #C00;*/">
                <p style="margin: 1px">REPORTE DE ULTIMO ASCENSO </p>
            </div>
            ...
            <table width="100%" style="border-collapse: collapse; border-spacing: 0; border: black 1px; margin-bottom: 5px; padding-top: 2px; padding-bottom: 2px;" class="table table-bordered table-striped">
                <thead style="background-color: lightgray;">
                    <tr>
                        ...
                        <th style="width:15%; text-align: center; border: 1px solid #000; height:30px; font-size: 12px;">GRADO</th>
                        <th style="text-align: center; border: 1px solid #000; height:30px; font-size: 12px;">PATERNO</th>
                        <th style="text-align: center; border: 1px solid #000; height:30px; font-size: 12px;">MATERNO</th>
                        <th style="text-align: center; border: 1px solid #000; height:30px; font-size: 12px;">NOMBRES</th>
                        <th style="text-align: center; border: 1px solid #000; height:30px; font-size: 12px;">CARNET MILITAR</th>
                        <th style="text-align: center; border: 1px solid #000; height:30px; font-size: 12px;">ANTIGUEDAD</th>
                    </tr>
                </thead>
                <tbody class="table-striped">
                    <?php
                        $x = 0;
                    ?>
                    @foreach($ascensosPersona as $row)
                    <?php
                        $x = $x + 1;
                    ?> 
                    <tr>  
                        <td style="border: 1px solid #000; padding: 2px; font-size: 11px; text-align: center;"><span><?php echo $x; ?></span></td>
                        <td style="border: 1px solid #000; padding: 12px; font-size: 12px; text-align: center;"><span>{{$row->grados}} {{$row->estu_abreviatura}}</span></td>
                        <td style="border: 1px solid #000; padding: 7px; font-size: 12px; text-align: left;"><span>{{$row->per_paterno}}</span></td>
                        <td style="border: 1px solid #000; padding: 7px; font-size: 12px; text-align: left;"><span>{{$row->per_materno}}</span></td>
                        <td style="border: 1px solid #000; padding: 7px; font-size: 12px; text-align: left;"><span>{{$row->per_nombre}}</span></td>
                        <td style="border: 1px solid #000; padding: 7px; font-size: 12px; text-align: center;"><span>{{$row->per_cm}}</span></td>
                        <td style="border: 1px solid #000; padding: 7px; font-size: 12px; text-align: center;"><span>{{$row->antigfin}}</span></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
            ...
            <div style="padding-top: 2px; padding-bottom: 2px; text-align: justify; font-size: 14px; font-weight: normal; /*border: 1px solid #C00;*/">
                <p style="margin: 1px">NOTA: Sujeto a verificación.</p>
            </div>
            ...
            <div style="padding-top: 0px; padding-bottom: 0px; text-align: center; position: fixed; bottom: 3.5cm; left: 3cm; right: -1cm; /*font-size: 14px; font-weight: bold;*/ /*border: 1px solid #C00;*/">

...
<head>
    ...
    <title>REPORTE DESIGNACIONES MILITARES</title>
    <!-- CSS only -->
    <style>
        @page{
            /*margin: 0rem;
...
<header>
    <div style="padding-top: 60px; padding-bottom: 1px;">
        ...
        <div style="padding-top: 30px; padding-bottom: 30px; text-align: center; font-size: 15px; font-weight: bold;">
            <p style="margin: 1px">DESIGNACIONES DE: {{$personal->grabrev}}{{$personal->estbrev}} {{$personal->per_nombre}} {{$personal->per_paterno}} {{$personal->per_materno}}</p><br>
            ...
            margin-bottom: 5px;" class="table table-bordered table-striped">
                <thead style="background-color: lightgray;">
                    <tr>
                        ...
                        <th style="text-align: center; border: 1px solid #000; height:30px; width:15%; font-size: 10px;">DOCUMENTO</th>
                        <th style="text-align: center; border: 1px solid #000; height:30px; width:10%; font-size: 10px;">NRO.DOC</th>
                        <th style="text-align: center; border: 1px solid #000; height:30px; width:10%; font-size: 10px;">FECHA</th>
                        <th style="text-align: center; border: 1px solid #000; height:30px; width:30%; font-size: 10px;">DESCRIPCION</th>
                        <th style="text-align: center; border: 1px solid #000; height:30px; width:25%;font-size: 10px;">OBSERVACION</th>
                    </tr>
                </thead>
                <tbody class="table-striped">
                    <?php
                        $x = 0;
                    ?>
                    @foreach($personal_designaciones as $ps)
                    <?php
                        $x = $x + 1;
                    ?>
                    <tr>
                        ...
                        <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$ps->ndoc}}</span></td>

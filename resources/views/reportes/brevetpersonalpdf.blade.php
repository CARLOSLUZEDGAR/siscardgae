...
<main>
    <div class="cabecera">
            <div style="padding-top: 30px; padding-bottom: 30px; text-align: center; font-size: 15px; font-weight: bold; /*border: 1px solid #C00;*/">
                <p style="margin: 1px">REPORTES DE BREVETS INDIVIDUALES</p>
            </div>
        ...
        margin-bottom: 5px;" class="table table-bordered table-striped">
            ...
            <tbody class="table-striped">
                ...
                <tr>
                    ...
                    <?php
                        $date = date_create($btp->fecha_imposicion);
                        $fechaimpo = date_format($date,"d/m/Y");
                    ?>
                    <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$btp->descripcion}}</span></td>
                    <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span><?php echo $fechaimpo; ?></span></td>
                    <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$btp->nombre}}</span></td>
                    <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$btp->puntaje}}</span></td>
                    <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$btp->tipodoc}}</span></td>
                </tr>
                @endforeach

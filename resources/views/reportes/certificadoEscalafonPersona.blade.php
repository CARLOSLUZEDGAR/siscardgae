...
<head>
    ...
    <title>CERTIFICADO DE ESCALAFON PERSONAL</title>
    <!-- CSS only -->
    ...
    <main>  
        ...
        <!--border: 1px solid #C00;-->
            ...
            <div style="padding-top: 5px; padding-bottom: 5px; text-align: right; font-size: 14px; font-weight: bold; /*border: 1px solid #C00;*/">
                <p style="margin: 1px">N° _ _/2022</p>
            </div>
                ...
                <table width="100%" style="border-collapse: collapse;border-spacing: 0; /*border: black 1px;*/ margin-bottom: 5px;" class="table table-bordered table-striped">
                    <tbody class="table-striped">
                        ...
                        <td width="45%" style="/*border: 1px solid #000;*/ padding: 7px; font-size: 10px; text-align: center;"><span><img style="width:90; height:90; border: 2px solid #142A98;" src="../public/img/personal/{{$personal->per_foto}}"></span></td>
                            ...
                            <td width="30%" style="/*border: 1px solid #000;*/ padding: 7px; font-size: 10px; text-align: left;">
                                <span>
            ...
            <div style="padding-top: 5px; padding-bottom: 5px; text-align: center; font-size: 15px; font-weight: bold; /*border: 1px solid #C00;*/">
                <p style="margin: 1px">ESCALAFONES</p>
            </div>
            ...
            margin-bottom: 5px;" class="table table-bordered table-striped">
                <thead style="background-color: lightgray;">
                    <tr>
                        ...
                        <th style="text-align: center; border: 1px solid #000; height:30px;font-size: 10px;">ESCALAFON</th>
                        <th style="text-align: center; border: 1px solid #000; height:30px;font-size: 10px;">SUB ESCALAFON</th>
                        <th style="text-align: center; border: 1px solid #000; height:30px;font-size: 10px;">GRADO</th>
                        <th style="text-align: center; border: 1px solid #000; height:30px;font-size: 10px;">DOCUMENTO</th>
                        <th style="text-align: center; border: 1px solid #000; height:30px;font-size: 10px;">NUM. DOC.</th>
                ...
                <tbody class="table-striped">
                    <?php
                        $x = 0;
                    ?>
                    @foreach($escalafonPersona as $row)
                    <?php
                        $x = $x + 1;
                    ?> 
                    ...
                    <tr>  
                        ...
                        <td style="border: 1px solid #000; padding: 7px; font-size: 12px; text-align: center;"><span><?php echo $fecha; ?></span></td>
                        <td style="border: 1px solid #000; padding: 7px; font-size: 12px; text-align: center;"><span>{{$row->escalafon_nombre}}</span></td>
                        <td style="border: 1px solid #000; padding: 7px; font-size: 12px; text-align: center;"><span>{{$row->subesc_nombre}}</span></td>
                        <td style="border: 1px solid #000; padding: 7px; font-size: 12px; text-align: center;"><span>{{$row->grados}}</span></td>
                        <td style="border: 1px solid #000; padding: 7px; font-size: 12px; text-align: center;"><span>{{$row->documento}}</span></td>
                        <td style="border: 1px solid #000; padding: 7px; font-size: 12px; text-align: center;"><span>{{$row->nro_doc}}</span></td>

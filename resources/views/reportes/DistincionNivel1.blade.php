...
<head>
    ...
    <title>DISTINCION NIVEL 1</title>
...
<body>
    <header >
        ...
        <div style="padding-top: 25px; padding-bottom: 30px; text-align: center; font-size: 15px; font-weight: bold;">
            <p style="margin: 1px">DISTINCIONES NIVEL 1</p>
        </div>
        ...
        <table width="100%" style="border-collapse: collapse; border-spacing: 0; border: black 1px; margin-bottom: 5px;" class="table table-bordered table-striped">
            ...
            <tbody class="table-striped">
                <?php
                    $x = 0;
                ?>
                @foreach($distincionesNivel1 as $d1)
                <?php
                    $x = $x + 1;
                ?>
                <tr>
                    <td style="border: 1px solid #000; padding: 7px; font-size: 10px; text-align: center;"><span><?php echo $x; ?></span></td>
                    <td style="border: 1px solid #000; padding: 7px; font-size: 10px;"><span>{{$d1->descripcion}}</span></td>
                    <td style="border: 1px solid #000; padding: 7px; font-size: 10px;"><span>{{$d1->observacion}}</span></td>
                    <td style="border: 1px solid #000; padding: 7px; font-size: 10px;"><span>{{$d1->estado?'Activo':'Desactivo'}}</span></td>
                </tr>
                @endforeach

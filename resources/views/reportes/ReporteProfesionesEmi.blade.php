        ...
        <table width="100%" style="border-collapse: collapse; border-spacing: 0; 
            ...
            <thead style="background-color: lightgray;">
                <tr>
                    ...
                    <th style="text-align: center; border: 1px solid #000; height:20px;" >LUGAR DE ESTUDIO</th>
            ...
            <tbody class="table-striped">
                ...
                <tr>
                    ...
                    <td style="border: 1px solid #000; padding: 5px; font-size: 10px;">{{$d->lugar_estudio}}</td>

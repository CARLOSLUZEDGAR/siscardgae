...
<head>
    ...
    <title>PROMOCION ESPECIALIDAD</title>
    <!-- CSS only -->
    <style>
        @page{
            /*margin: 0rem;
    ...
    <main>  
        ...
        <!--border: 1px solid #C00;-->
                ...
                <div style="padding-top: 30px; padding-bottom: 30px; text-align: center; font-size: 15px; font-weight: bold; /*border: 1px solid #C00;*/">
                    <p style="margin: 1px">PROMOCIÓN ESPECIALIDADES</p>
                </div>
            ...
            margin-bottom: 5px;" class="table table-bordered table-striped">
                <thead style="background-color: lightgray;">
                    <tr>
                        ...
                        <th style="text-align: center; border: 1px solid #000; height:30px;font-size: 10px;">AP. PATERNO</th>
                        <th style="text-align: center; border: 1px solid #000; height:30px;font-size: 10px;">AP. MATERNO</th>
                        <th style="text-align: center; border: 1px solid #000; height:30px;font-size: 10px;">NOMBRES</th>
                        <th style="text-align: center; border: 1px solid #000; height:30px;font-size: 10px;">ESPECIALIDAD</th>
                        <th style="text-align: center; border: 1px solid #000; height:30px;font-size: 10px;">SUBESPECIALIDAD</th>
                    </tr>
                </thead>
                <tbody class="table-striped">
                    <?php
                    ...
                    <tr>  
                        ...
                        ?>
                        <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$row->per_cm}}</span></td>
                        <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$row->grado}}{{$row->complemento}}</span></td>
                        <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$row->per_paterno}}</span></td>
                        <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$row->per_materno}}</span></td>
                        <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$row->per_nombre}}</span></td>
                        <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$row->nomespe}}</span></td>
                        <td style="border: 1px solid #000; padding: 7px; font-size: 8px;"><span>{{$row->nomsubespe}}</span></td>
                    </tr>
                    @endforeach

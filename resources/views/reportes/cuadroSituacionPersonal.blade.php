...
<head>
    ...
    <title>CUADRO SITUACIÓN PERSONAL</title>
    <!-- CSS only -->
    ...
    <main>  
        <div class="cabecera">                    
            ...
            <div style="padding-top: 1cm; padding-bottom: 1cm; text-align: center; font-size: 14pt; font-weight: bold; /*border: 1px solid #C00;*/">
                ...
                <p style="margin: 0px;"><u>CUADRO DE SITUACIÓN MILITAR DEL PERSONAL GESTIÓN <?php echo $gestion; ?></u></p>               
            </div>
            ...
            <table width="100%" style="border-collapse: collapse; border-spacing: 0; border: black 1px; margin-bottom: 5px; padding-top: 2px; padding-bottom: 2px;" class="table table-bordered table-striped">
                <tr>
                    ...
                    <td style="border: 1px solid #000; padding-top: 0.2cm; padding-bottom: 0.2cm; font-size: 8pt; text-align: center; font-weight: bold; /*width: 2cm;*/"><div>APELLIDOS Y NOMBRES</div></td>
                    <td style="border: 1px solid #000; padding-top: 0.2cm; padding-bottom: 0.2cm; font-size: 8pt; text-align: center; font-weight: bold; /*width: 2cm;*/"><div>SITUACIÓN</div></td>
                    <td style="border: 1px solid #000; padding-top: 0.2cm; padding-bottom: 0.2cm; font-size: 8pt; text-align: center; font-weight: bold; /*width: 2cm;*/"><div>DETALLE SITUACIÓN</div></td>
                </tr>
                ...
                <tr>
                    ...
                    ?>
                    <td style="border: 1px solid #000; padding: 0.1cm; font-size: 8pt; text-align: center; /*font-weight: bold; width: 2cm;*/"><div>{{$row->cm}}</div></td>
                    <td style="border: 1px solid #000; padding: 0.1cm; font-size: 8pt; text-align: center; /*font-weight: bold; width: 2cm;*/"><div>{{$row->grado}}</div></td>
                    <td style="border: 1px solid #000; padding: 0.1cm; font-size: 8pt; text-align: left; /*font-weight: bold; width: 2cm;*/"><div>{{$row->nombre}}</div></td>
                    <td style="border: 1px solid #000; padding: 0.1cm; font-size: 8pt; text-align: center; /*font-weight: bold; width: 2cm;*/"><div>{{$row->nomsit}}</div></td>
                    <td style="border: 1px solid #000; padding: 0.1cm; font-size: 8pt; text-align: center; /*font-weight: bold; width: 2cm;*/"><div>{{$row->nomdetsit}}</div></td>
                    <?php
                        $x++;
                    ?>
                </tr>

        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Homeff</a></li>
            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <select class="form-control" placeholder="Ap. Paterno" v-model="criterio">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" style="text-transform:upperacase;" @keyup="BuscarPersona()" v-model="buscar" >
                        </div>
                        <!-- <div class="col-md-3">
                ...
                <tbody>
                    <tr v-for="p in listaPersonal"> 
                        ...
                        <td class="text-center">
                          &nbsp;
                            <button type="button" class="btn btn-success btn-sm" title="INDIVIDUAL" @click="EnvioNombre(p.per_codigo, p.grado, p.complemento, p.nombre, p.paterno, p.materno)">
                            <i class="fa fa-eye" aria-hidden="true"></i>
                            </button> &nbsp;
                            <button v-if="p.gid == 6 || p.gid == 5 || p.gid == 4" type="button" class="btn btn-primary btn-sm" title="DELEGADO" @click="EnvioNombre2(p.per_codigo)">
...
export default {
    ...
    computed:{
        ...
        // nombreCompleto(){
        //     this.nombre_completo = this.per_codigo + ' ' + this.gra_abreviatura + ' ' + this.estu_abreviatura + ' ' + this.per_nombre + ' ' + this.per_paterno + ' ' + this.per_materno
        // }
    },
    mounted() {
    ...
    methods: {
      ...
      /*  EnvioNombre(grado,nombre,apaterno,amaterno){
            this.$router.push({
            name: "DatoPersonal",
            params:{
                g:grado,

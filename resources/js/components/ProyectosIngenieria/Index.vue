<template>
  <div>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Lista Personal</li>
            </ol>
          </div>
        </div>
      </div>
                  ...
                  <div class="row d-flex justify-content-left">
                      <div class="col-md-8">
                          <div class="input-group">
                              ...
                              <input type="text" class="form-control col-md-5" style="text-transform:uppercase;" @keyup="BuscarPersona()" v-model="buscar">
                              <!-- <button type="button" class="btn btn-primary form-control col-md-4" @click="ListarPersonal(1,buscar,criterio)">
    ...
    <!-- cUERPO PARA VER LISTA PERSONAL -->
                      ...
                      <tbody>
                          <tr v-for="p in listaPersonal">
                              ...
                              <td class="text-center">
                                  <button type="button" @click="IrCreate(p.per_codigo)" class="btn btn-success"><i class="fa fa-eye"></i></button>
                              </td>                    
                          </tr>
...
export default {
    data() {
        return {
          //variables globales -> son las varibales iniciales cuando se carga la pagina
            listaPersonal: [],
            criterio: "p.per_cm",
            buscar:"",
            setTiemoutBuscador: '',

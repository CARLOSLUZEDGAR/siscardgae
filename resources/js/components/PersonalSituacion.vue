        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Situacion Personal</li>
            </ol>
          </div>
        </div>
      </div>
                  ...
                  <table class="table table-bordered table-striped table-sm">
                      ...
                      <tbody>
                          <tr v-for="personal in arrayPersonal" :key="personal.id"> 
                              <td v-text="personal.per_codigo"></td>
 ...
 computed: {
  ...
  methods: {
    ...
    listarPersonal(page,buscar,criterio){
      ...
      var url = '/listarPersonalSituacion?page=' + page + '&buscar=' + this.buscar + '&criterio=' + criterio;

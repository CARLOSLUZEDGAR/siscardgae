              ...
              <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="table-wrapper-scroll-y my-custom-scrollbar" id="myTable" style="font-size: 13px;" >
                      ...
                      <template v-if="datfis2==1">
                          <table class="table table-bordered table-striped table-sm">
                              ...
                              <tbody>
                                  <tr v-for="personal in listaPersonal"> 
                                      <td v-text="personal.grado+' '+personal.complemento"></td>
                                      <td v-text="personal.paterno"></td>
                                      <td v-text="personal.materno"></td>
                                      <td v-text="personal.nombre"></td>
                                      <td class="text-center" v-text="personal.ci"></td>
                                      <td class="text-center" v-text="personal.cm"></td>
                                      <td style="width:100px; text-align:center">
                                          <button type="button" @click="EnvioDatos(personal.per_codigo)" @click.stop="()=>{isHidden = false;datfis2=0}" class="btn btn-success btn-sm">

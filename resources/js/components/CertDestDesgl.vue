        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Reporte Certificado Destinos Desglose</li>
            </ol>
          </div>
        </div>
      </div>
                        ...
                        <div style="" class="col-md-12 d-flex flex-column bd-highlight mb-3">
                              ...
                              <table class="table table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                    <tr v-for="personalDestinos in arrayPersonalDestinos" :key="personalDestinos.id">
                                        ...
                                        <td>{{personalDestinos.desc_dn2}}&nbsp;&nbsp;&nbsp; - &nbsp;&nbsp;&nbsp;{{personalDestinos.desc_dn3}}&nbsp;&nbsp;&nbsp; - &nbsp;&nbsp;&nbsp;{{personalDestinos.desc_dn4}}</td>
                                    </tr>
                                </tbody>
                              </table>
                            </div>
                            ...
                            <div class="row p-2 bd-highlight">
                              <div class="col-md-12">
                                  ...
                                  <textarea name="textarea" class="form-control" rows="3" v-model="notaDesg" placeholder="SIN OBSERVACIONES"></textarea>
                              </div>
                            </div>

                            <div class="row p-2 bd-highlight justify-content-center">
                              <div class="col-md-4"> 
                                <button v-if="$auth.can('report-certdestdesg')" type="button" class="btn btn-secondary btn-sm btn-block" @click="CertDestDesgl(per_codigo,notaDesg,nro_doc,rubrica)">
...
export default {
    ...
    methods: {
        ...
        CertDestDesgl(per_codigo,notaDesg,nro_doc,rubrica){
          this.$v.$reset();
        if(!this.$v.$invalid){
          // window.open('http://127.0.0.1:8000/certificadoDestDesglose?per_codigo='+per_codigo+'&notaDesg='+notaDesg+'&nro_doc='+nro_doc+'&rubrica='+rubrica);
          window.open('http://sipefab.fab.bo/certificadoDestDesglose?per_codigo='+per_codigo+'&notaDesg='+notaDesg+'&nro_doc='+nro_doc+'&rubrica='+rubrica);

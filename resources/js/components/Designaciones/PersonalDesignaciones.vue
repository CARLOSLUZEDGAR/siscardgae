                        ...
                        <div class="row  d-flex justify-content-left">
                            <div class="col-md-8 ">
                                    <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" @keyup="BuscarPersona()" style="text-transform:uppercase;" v-model="buscar">
                                    ...
                                    <tbody>
                                        <tr v-for="p in listaPersonal"> 
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button type="button" class="btn btn-success btn-sm" @click="VerDesignaciones(p.per_codigo)">

  ...
  <div>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                     ...
                     <div class="col-md-10 d-flex align-items-center">
                        <div style="" class="col-md-12 d-flex flex-column bd-highlight mb-3">
                            ...
                            <div class="row p-2 bd-highlight justify-content-center">
                                    <div v-if="$auth.can('insert-desig')" class="col-md-4">                                            
                                        <button class="btn btn-sm btn-success btn-block" @click="NuevaDesignacion()">
                                            <i class="fa fa-plus-circle"></i> &nbsp;
                                            Nueva Designación 
                                        </button>
                                        
                                    </div>
                                    <div v-if="$auth.can('report-desig')" class="col-md-4">  
                                        <button type="button" @click="ReporteDesignacion(datos.codigo)" class="btn btn-sm btn-secondary btn-block">
                                         <i class="far fa-file-pdf"></i>&nbsp;Reporte Personal
                                        </button>
                                    </div>
                                     <div class="col-md-4">  
                                        <router-link type="button" class="btn-danger btn-sm btn position-reverse btn-block" :to="'/personaldesignaciones'">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body">
                            <template v-if="designacion.length > 0">
                                <table class="table table-bordered table-striped table-sm">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 40%" class="text-center">DESCRIPCION</th>
                                            <th style="width: 20%" class="text-center">OBSERVACION</th>
                                            
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr v-for="s in designacion " :key="s.id">
                                             <td class="text-center">
                                                <!--<button type="button" class="btn btn-success btn-sm" @click="verDatos(p.codigo)">
                                                    <i class="far fa-eye"></i>
                                                </button>-->
                                                <button v-if="$auth.can('edit-desig')" type="button" class="btn btn-warning btn-sm" @click="AbrirEditarSituacion(s.codigo)">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                                <button v-if="$auth.can('delete-desig')"  type="button" class="btn btn-danger btn-sm" @click="EliminarSituacionMilitar(s.codigo)">
      ...
      <!-- /.container-fluid -->
        ...
        <div class="modal fade" id="NuevaDesignacion">
           <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">REGISTRAR NUEVA DESIGNACION</h4>
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-4">
                        ...
                        <br>
                        <select name="documento" id="doc" class="form-control" :class="{ 'is-invalid' : $v.documento.$error, 'is-valid':!$v.documento.$invalid }"
                         v-model="documento" style="text-transform:uppercase">
                            <option value="MEMORANDUM" selected>MEMORANDUM</option>
                            <option value="ORDEN DEL DIA">ORDEN DEL DIA</option>
                            <option value="ORDEN DE DESTINOS">ORDEN DE DESTINOS</option>
            ...
            <div class="modal-footer">              
              <button type="button" class="btn btn-primary" @click="RegistrarDesignacion()">Guardar</button>
        ...
        <div class="modal fade" id="EditarSituacionMilitar">
          ...
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">EDITAR DESIGNACION</h4>
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <label for="">DESCRIPCION:</label>
                        <input class="form-control" type="text" style="text-transform:uppercase;" v-model="descripcionA">  
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <label for="">OBSERVACION:</label>
                        <input class="form-control" type="text" style="text-transform:uppercase;" v-model="observacionA">
...
export default {
    ...
    methods: {
        ...
        cambiarPagina(page){
                ...
                me.listarDesignacion(page);
            },

        listarDesignacion(page){
            let me = this;
            axios
            .post("/listarDesignacion", {
                percodigo: me.percod,
                page: page
            })
            .then(function (response) {
                if (response.data.code == "200") {
                    me.designacion = response.data.datos.data;
        ...
        NuevaDesignacion(){
            ...
            $('#NuevaDesignacion').modal('show');
            $(".modal-header").css("background-color", "#007bff"); 
            $(".modal-header").css("color", "white" ); 
        },

        
        RegistrarDesignacion(){
            this.$v.$reset();
            if(!this.$v.$invalid){
            swal.fire({
                title: '¿Desea guardar la nueva Designación?', // TITULO 
                ...
                axios
                    ...
                    .then(function (response) {
                        ...
                        me.listarDesignacion();
                        me.listarDatosPersonalSituacion();
                        $('#NuevaDesignacion').modal('hide');
                        swal.fire(
                            "Aceptado", //TITULO
                            "Se añadio correctamente la nueva Designación.", //TEXTO DE MENSAJE
                    ...
                    swal.fire(
                        "Anulado", //TITULO
                        "No se realizo el registro de la nueva Designacion.", //TEXTO DE MENSAJE
        ...
        AbrirEditarSituacion(s){
            ...
            me.iddesigna = s;
            axios
            .post("/listarDesignacionModificar", {
                sitpercod: s
            })
            .then(function (response) {
        ...
        EditarSituacionMilitar(){
            ...
            swal.fire({
                title: '¿Desea realizar la modificación de la Designación ?', // TITULO 
                icon: 'question', //ICONO (success, warnning, error, info, question)
                showCancelButton: true, //HABILITACION DEL BOTON CANCELAR
                confirmButtonColor: 'info', // COLOR DEL BOTON PARA CONFIRMAR
                cancelButtonColor: '#868077', // CLOR DEL BOTON CANCELAR
                ...
                let me = this;
                    ...
                    .then(function (response) {
                        ...
                        swal.fire(
                            "Aceptado", //TITULO
                            "Se modificó correctamente la Designación.", //TEXTO DE MENSAJE
                            "success" // TIPO DE MODAL (success, warnning, error, info)
                        )
                        me.listarDesignacion();
                        me.listarDatosPersonalSituacion();
        ...
        EliminarSituacionMilitar(codigo){
            swal.fire({
                title: '¿Desea realizar la eliminación de la Designación ?', // TITULO 
                icon: 'question', //ICONO (success, warnning, error, info, question)
                showCancelButton: true, //HABILITACION DEL BOTON CANCELAR
                confirmButtonColor: 'info', // COLOR DEL BOTON PARA CONFIRMAR
                cancelButtonColor: '#868077', // CLOR DEL BOTON CANCELAR
                ...
                let me = this;
                    ...
                    .then(function (response) {
                        ...
                        swal.fire(
                            "Aceptado", //TITULO
                            "Se eliminó correctamente la Designación.", //TEXTO DE MENSAJE
                            "success" // TIPO DE MODAL (success, warnning, error, info)
                        )
                        me.listarDesignacion();
                        me.listarDatosPersonalSituacion();
                    ...
                    .catch(function (error) {
                        ...
                        console.log(error);
                            ...
                            swal.fire(
                            "Anulado", //TITULO
                            "No se realizo la eliminación de la Designación.", //TEXTO DE MENSAJE
                            "info" // TIPO DE MODAL (success, warnning, error, info)
                            );
                        }
                    })
        ...
        ReporteDesignacion(codigo){
            window.open('http://sipefab.fab.bo/DesignacionesPdf?per_codigo='+codigo);
        },

                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="step" v-if="currentStep === 1">
                            <h3><i class="far fa-folder"></i>&nbsp;PASO 1: DOCUMENTACIÓN AERONAVE</h3>
                            <br>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label class="form-control-label" for="text-input">MATRICULA Y MODELO: {{matricula}} {{modelo}}</label>
                                </div>
                            </div>
                            <div class="table-wrapper-scroll-y my-custom-scrollbar" id="myTable" style="font-size: 12pt;">
                                <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody>
                                        <tr v-for="(documento,index) in arrayDocumentosAeronave"> 
    ...
    methods: {
        ...
        DatosAeronave(aeronave_id){ //DGAE
            ...
            .then(function (response) {
                ...
                me.arrayDocumentosAeronave = response.data.aeronave_documento;

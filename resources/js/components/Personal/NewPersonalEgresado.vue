          ...
          <div class="col-sm-6">    
                <div class="row">
                    <h1>
                        ...
                        REGISTRO NUEVO PERSONAL EGRESADO
                    </h1>&nbsp; &nbsp;
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="row" style="margin-top: 5px;">
                                <div class="col-md-3">
                                    ...
                                    <input type="text"  class="form-control" style="text-transform:uppercase;" readonly v-model="Asituacion">
                                </div>
                                <div class="col-md-4">
                                    <label for="">SUBSITUACION</label>
                                    <input type="text"  class="form-control" style="text-transform:uppercase;" readonly v-model="Asubsituacion">
                                </div>
                                <div class="col-md-5">
                                    <label for="">DETALLE SITUACION</label>
                                    <input type="text"  class="form-control" style="text-transform:uppercase;" readonly v-model="AdetalleSituacion">
                                </div>
                            </div>
                        </fieldset>
                        <fieldset class="scheduler-border">
                            ...
                            <div class="row" style="margin-top: 5px;">
                                <div class="col-md-3">
                                    ...
                                    <input type="text"  class="form-control" style="text-transform:uppercase;" readonly v-model="Aescalafon">
                                </div>
                                <div class="col-md-5">
                                    <label for="">SUBESCALAFON</label>
                                    <select class="form-control" v-model="formData.subescalafon" @change="Grado" :class="hasError('subescalafon') ? 'is-invalid' : ''">
                                        <option value="3">OFICIALES SUBALTERNOS</option>
                                        <option value="6">SARGENTOS</option>                                     
                                        <option value="21">SARGENTO DE MUSICA</option>                                     
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text"  class="form-control" style="text-transform:uppercase;" readonly v-model="Agrado">
...
export default {
    ...
    data(){
        ...
        return {
            ...
            //Situacion
            Asituacion: 'ACTIVO',
            Asubsituacion: 'SERVICIO ACTIVO',
            AdetalleSituacion: 'INCORPORACION',
            //Localidad
            Adepartamento:[],
            Aprovincia:[],
            Alocalidad:[],
            ...
            validationRules: [
                ...
                { 
                    ...
                    sitTipoDocumento: { required, maxLength: maxLength (30) },
                ...
                { 
                    ...
                    comDocumento: { required, maxLength: maxLength (30) },
    ...
    methods: {
        ...
        Grado(){
                let me = this;
                me.Agrado = '';
                if (me.formData.subescalafon == 3) {
                    me.Agrado = 'CADETE';
                    me.formData.grado = 49;
                } else if (me.formData.subescalafon == 6) {
                    me.Agrado = 'ALUMNO POLITECNICO';
                    me.formData.grado = 50;
                } else{
                    me.Agrado = 'ALUMNO DE MUSICA';
                    me.formData.grado = 173;
                }
        ...
        Registrar(){
            swal.fire({
                ...
                if (result.value) {                
                    let me = this;
                    axios
                    .post("/registrarPersonalEgresado", {                        
                        data: me.formData,
                    })
                    .then(function (response) {

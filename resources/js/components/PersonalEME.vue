        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">COMPONENTE PERSONAL</li>
            </ol>
          </div>
        </div>
      </div>
                ...
                <div class="form-group row">
                  <div class="col-md-8">
                    <div class="input-group">
                      ...
                      <input type="text" v-model="buscar"  class="form-control" style="text-transform:uppercase" @keyup="BuscarPersona()">

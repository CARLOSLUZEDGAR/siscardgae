                            ...
                            <div class="col-md-10 d-flex align-items-center">
                                <div style="" class="col-md-12 d-flex flex-column bd-highlight mb-3">
                                    ...
                                    <div class="row p-2 bd-highlight justify-content-center">
                                        <div class="col-md-2">
                                            <button v-if="$auth.can('view-repdesglose')" type="button" class="btn btn-secondary btn-sm btn-block" @click="EnvioDesglose(per_codigo)" style="width: 100%;">
                                                <i class="far fa-file-alt" aria-hidden="true">  Desglose</i>
                                            </button> &nbsp;
                                        </div>
                                        <div class="col-md-2"> 
                                            <button v-if="$auth.can('view-certdestasc')" type="button" class="btn btn-secondary btn-sm btn-block" @click="EnvioCertAsc(per_codigo)" style="width: 100%;">
                                                <i class="far fa-file-alt" aria-hidden="true">  Destinos Ascensos</i>
                                            </button> &nbsp;
                                        </div>
                                        <div class="col-md-2">
                                            <button v-if="$auth.can('view-certdestfront')" type="button" class="btn btn-secondary btn-sm btn-block" @click="EnvioCertFront(per_codigo)" style="width: 100%;">
                                                <i class="far fa-file-alt" aria-hidden="true">  Destinos Frontera</i>
                                            </button> &nbsp;
                                        </div>
                                        <div class="col-md-2">
                                            <button v-if="$auth.can('view-certdestdesg')" type="button" class="btn btn-secondary btn-sm btn-block" @click="EnvioCertDesgl(per_codigo)" style="width: 100%;">
                                                <i class="far fa-file-alt" aria-hidden="true">  Destino Desglose</i>
                                            </button> &nbsp;
                                        </div>
                                        <div class="col-md-2">
                                            <button v-if="$auth.can('view-certdestserv')" type="button" class="btn btn-secondary btn-sm btn-block" @click="EnvioDesgServ(per_codigo)" style="width: 100%;">
                                                <i class="far fa-file-alt" aria-hidden="true">  Destinos Años Servicio</i>
                                            </button> &nbsp;
                                        </div>
                                    </div>
                    ...
                    <table class="table table-bordered table-striped table-sm">
                        ...
                        <tbody>
                            <tr v-for="personalDestinos in arrayPersonalDestinos" :key="personalDestinos.id">
                                ...
                                <td style="width:100px; text-align:center">{{ arrayPersonalDestinos2.find(function(el) { return el.idpersonal_destinos == personalDestinos.idpersonal_destinos; } ).cargo2 }}</td>                
                ...
                swal.fire({
                    ...
                    if (result.value) {
                        ...
                        //NOMBRE ENVIA AL CONTROLADOR : me.NOMBRE V-MODEL O VARIBLE DECLARADA
                            ...
                            perdest_grado : me.perdest_grado,

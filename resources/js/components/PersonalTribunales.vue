<template>
    <main>
        <section class="content-header">
            <h1><i class="fas fa-gavel"></i> PERSONAL TRIBUNALES</h1>
        </section>
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <div v-if="$auth.can('report-rangfechpertrib')" class="col-md-12">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <!-- <div class="col-md-3">
                                        <button type="button" @click="listarPersonal(buscar,criterio)" class="btn btn-primary"><i class="fas fa-search"></i> Buscar</button>
                                    </div> -->
                                </div>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            <tr v-for="p in listaPersonal">
                                                ...
                                                <td style="width:100px" class="text-center">
                                                    <button type="button" class="btn btn-success btn-sm" title="Ver Tribunales"
                                                        @click="EnvioVerTribunales(p.per_codigo,p.subescalafon)">
...
export default {
    ...
    methods: {
        ...
        EnvioVerTribunales(per_codigo,subescalafon)
        {
            this.$router.push({
        ...
        generarPDF(fecha_inicio,fecha_fin){
            ...
            window.open('http://sipefab.fab.bo/reporte/generarRangofechasTribunales?inicio='+ fecha_inicio + '&fin=' + fecha_fin, '_blank');
        }
    },
}
</script>

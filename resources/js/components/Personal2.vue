<template>
  <div>
    ...
    <section class="content">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                    <div class="form-group row">
                      ...
                      <div class="col-md-2">
                        <button v-if="$auth.can('report-ordest')" type="button" class="btn btn-secondary btn-sm form-control" @click="FirmasOGD()">
                          <i class="far fa-file-alt" aria-hidden="true">  Orden de Destinos</i>
                        </button> &nbsp;
                      </div>
                      <div class="col-md-2">
                        <button type="button" class="btn btn-secondary btn-sm form-control" @click="cuadroEfectivos()">
                          <i class="far fa-file-alt" aria-hidden="true">  Cuadro de Efectivos</i>
                        </button> &nbsp;
                      </div>
                       <div class="col-md-2">
                        <button v-if="$auth.can('mail-destino')" type="button" class="btn btn-primary btn-sm form-control" @click="modalEmail()">
                        <!-- <button type="button" class="btn btn-primary btn-sm form-control" @click="modalEmail()"> -->
                          <i class="far fa-file-alt" aria-hidden="true">  Envio Destinos</i>
                        </button> &nbsp;
                      </div>
                    </div>
                    <!-- <div class="form-group row">
      ...
      <!-- /.container-fluid -->
      <div class="modal fade" id="Envioemail">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" v-model="doc" class="form-control" :class="{ 'is-invalid' : $v.doc.$error, 'is-valid':!$v.doc.$invalid }">
                            <div class="invalid-feedback">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" @click="envioDestinos()">Enviar</button>
...
export default {
  ...
  validations:{
            ...
            validationGroupEmail: ['gestion', 'doc'],
  ...
  methods: {
    ListarPersonal(page){
        ...
        modalEmail(){
            ...
            this.gestion = '',
            this.doc = '',
            $('#Envioemail').modal('show');
            $(".modal-header").css("background-color", "#007bff");
            $(".modal-header").css("color", "white" );
            $(".modal-title-registro").text("Enviar Destinos");
        },
        ...
        envioDestinos(){
          ...
          if(!this.$v.validationGroupEmail.$invalid){
            swal.fire({
                title: '¿Desea enviar los destinos por correo?', // TITULO 
                ...
                if (result.value) {
                    ...
                    .then(function (response) {
                        ...
                        $('#Envioemail').modal('hide');
                        me.gestion = '';
                        me.doc = '';
                        swal.fire({
                            title : 'Se envio correctamente los correos', // TITULO 
                            icon : 'success' //ICONO (success, warnning, error, info, question)
                        });
        ...
        cuadroEfectivos(){
          window.open('http://sipefab.fab.bo/cuadroEfectivos');
        },

<template>
    <main>
        <section class="content-header">
            <h1><i class="fas fa-user-graduate"></i> Personal Cursos</h1>
        </section>
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <div v-if="$auth.can('report-rangfechpercur')" class="col-md-12">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <router-link type="button" :to="'/reportcurso'" class="btn btn-primary"><i class="fas fa-file-pdf"></i> Reportes</router-link>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            <tr v-for="p in listaPersonal">
                                                ...
                                                <td style="width:100px" class="text-center">
                                                    <button type="button" class="btn btn-success btn-sm" title="Ver Cursos"
                                                        @click="EnvioVerCursos(p.per_codigo)">
...
export default {
    ...
    methods: {
        ...
        generarPDF(fecha_inicio,fecha_fin){
            window.open('http://sipefab.fab.bo/reporte/generarRangofechasPersonalCursos?inicio='+ fecha_inicio + '&fin=' + fecha_fin, '_blank');
        }
    }
}
</script>

    ...
    <div>
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <li class="breadcrumb-item active">Faltas Personales</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <section class="content">
            <div class="container-fluid">
                                    ...
                                    <div class="col-md-10 d-flex align-items-center">
                                        <div style="" class="col-md-12 d-flex flex-column bd-highlight mb-3">
                                            ...
                                            <div class="row p-2 bd-highlight justify-content-center">
                                                <template v-if="r == 1">
                                                    <div v-if="$auth.can('insert-fald1')" class="col-md-4">                                            
                                                        <button class="btn btn-sm btn-success btn-block" @click="NuevaFaltaDpto1()">
                                                            <i class="fas fa-plus"></i> &nbsp;
                                                            Agregar Falta
                                                        </button>
                                                    </div>
                                                    <div v-if="$auth.can('insert-falextd1')" class="col-md-4">                                            
                                                        <button class="btn btn-sm btn-success btn-block" @click="NuevaFaltaDpto2()">
                                                            <i class="fas fa-plus"></i> &nbsp;
                                                            Agregar Falta Externo
                                                        </button>
                                                    </div>
                                                </template>
                                                <template v-else>
                                                    <div v-if="$auth.can('insert-faluni')" class="col-md-4">                                            
                                                        <button class="btn btn-sm btn-primary btn-block" @click="NuevaFaltaUnidades()">
                                                            <i class="fas fa-plus"></i> &nbsp;
                                                            Agregar Falta
                                                        </button>
                                                    </div>
                                            ...
                                            <div class="row p-2 bd-highlight justify-content-center">
                                                <template v-if="r == 1">
                                                    <div v-if="$auth.can('insert-fald1')" class="col-md-4">                                            
                                                        <button class="btn btn-sm btn-primary btn-block" @click="ImprimirRecord()">
                ...
                <!-- LISTA DE FALTAS -->
                <div class="row">
                    <div class="col-md-12 table-wrapper-scroll-y my-custom-scrollbar" style="font-size: 13px;">
                        <div class="card card-dark card-outline">
                        <div class="card-header">
                            <h3 class="card-title">
                                ...
                                <tbody>
                                    <tr v-for="p in Ademeritos">
                                        <td class="text-center">
                                            <template v-if="p.estado != 2">
                                                <button v-if="$auth.can('edit-falta')" type="button" class="btn btn-warning btn-sm" @click="EditarFalta(p.id, p.externo)">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                            </template>
                                            
                                            <button v-if="$auth.can('view-falta')" type="button" class="btn btn-success btn-sm" @click="VerDatosModal(p.id)">
                                                <i class="fas fa-eye"></i>
                                            </button>
                                            <template v-if="p.estado != 2">
                                                <button v-if="$auth.can('view-falta')" type="button" class="btn btn-danger btn-sm" @click="LevantarSancion(p.id)">
                                                    <i class="fas fa-trash"></i>
                                                </button>
                                            </template>
                                            <template v-if="p.estado === 2">
                                                <button v-if="$auth.can('view-falta')" type="button" class="btn btn-danger btn-sm" @click="VerDatosLev(p.id)">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                            </template>
                                            <template v-if="r != 1">
                                                <button v-if="$auth.can('report-memofal')" type="button" class="btn btn-secondary btn-sm" @click="Imprimir(p.id)">
                                                    <i class="far fa-file-alt"></i>
                                                </button>
                                            </template>
                                        ...
                                        <td class="text-center" style="vertical-align: middle;">
                                            ...
                                            <div v-else-if="p.estado === 2">
                                                <span class="badge badge-danger">Sin Efecto</span> 
                                            </div> 
                                            <div v-else>
            ...
            <!-- /.container-fluid -->
            <!-- MODAL QUE PERMITE REALIZAR UN LEVANTAMIENTO DE ARRESTO -->
            <div class="modal fade" data-backdrop="static" id="LevFalta">
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">DEJAR SIN EFECTO SANCIÓN</h4>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" :class="{ 'is-invalid' : $v.nomlev.$error, 'is-valid':!$v.nomlev.$invalid }" @keypress="onlyletters" class="form-control" style="text-transform:uppercase;" v-model="nomlev">
                                    <div class="invalid-feedback">
                                        <span v-if="!$v.nomlev.required">Este campo es Requerido</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label for="">CARGO:</label>
                                    <input type="text" :class="{ 'is-invalid' : $v.cargolev.$error, 'is-valid':!$v.cargolev.$invalid }" @keypress="onlyletters" style="text-transform:uppercase;" class="form-control" v-model="cargolev">
                                    <div class="invalid-feedback">
                                        <span v-if="!$v.cargolev.required">Este campo es Requerido</span>                                    
                                        <span v-if="!$v.cargolev.maxLength">Este campo permite solo 255 caracteres.</span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <v-select
                                        ...
                                        :options="Adocumentos"
                                        v-model="doclev"
                                        :class="{ 'is-invalid' : $v.doclev.$error, 'is-valid':!$v.doclev.$invalid }"
                                    >
                                    ...
                                    <div class="invalid-feedback">
                                        <span v-if="!$v.doclev.required">Este campo es Requerido</span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <label for="">NUMERO DOCUMENTO:</label>
                                    <input type="number" :class="{ 'is-invalid' : $v.ndoclev.$error, 'is-valid':!$v.ndoclev.$invalid }" @keypress="onlyNumber" class="form-control" min="0" style="text-transform:uppercase;" v-model="ndoclev">
                                    <div class="invalid-feedback">
                                        <span v-if="!$v.ndoclev.required">Este campo es Requerido</span>
                                        <span v-if="!$v.ndoclev.maxLength">Este campo permite solo 10 caracteres.</span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <date-picker class="dat" value-type="date" format="DD/MM/YYYY"
                                        ...
                                        :class="{ 'is-invalid' : $v.fechalev.$error, 'is-valid':!$v.fechalev.$invalid }"
                                    ></date-picker>                                        
                                    <div class="invalid-feedback">
                                        <span v-if="!$v.fechalev.required">Este campo es Requerido</span>
                                    </div>
                                </div>
                            </div>
                             <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" :class="{ 'is-invalid' : $v.destlev.$error, 'is-valid':!$v.destlev.$invalid }" @keypress="onlyletters" class="form-control" style="text-transform:uppercase;" v-model="destlev">
                                    <div class="invalid-feedback">
                                        <span v-if="!$v.destlev.required">Este campo es Requerido</span>
                                        <span v-if="!$v.destlev.maxLength">Este campo permite solo 300 caracteres.</span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="" id="" :class="{ 'is-invalid' : $v.observacionlev.$error, 'is-valid':!$v.observacionlev.$invalid }" class="form-control" cols="30" rows="3" v-model="observacionlev"></textarea>
                                    <div class="invalid-feedback">
                                        <span v-if="!$v.observacionlev.required">Este campo es Requerido</span>
                                        <span v-if="!$v.observacionlev.maxLength">Este campo permite solo 500 caracteres.</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" @click="GuardarLev()">
                                Guardar
                            </button>
            ...
            <!-- MODAL PARA UNA NUEVA FALTA EN LA UNIDAD -->
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" class="close" @click="CerrarModalLev" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            ...
                            <fieldset class="scheduler-border">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label for="">CARGO:</label>
                                        <input type="text" :class="{ 'is-invalid' : $v.cargo.$error, 'is-valid':!$v.cargo.$invalid }" @keypress="onlyletters" style="text-transform:uppercase;" class="form-control" v-model="cargo">
                                        <div class="invalid-feedback">
                            ...
                            <fieldset class="scheduler-border">
                                ...
                                <div class="row">                        
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" :class="{ 'is-invalid' : $v.dias.$error, 'is-valid':!$v.dias.$invalid }" @keypress="onlyNumber" min="0" class="form-control" v-model="dias">
                                        <div class="invalid-feedback">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-danger" @click="CerrarModalLev" data-dismiss="modal">Cerrar</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
            ...
            <!-- /.modal -->
            <!-- PERMITE VER LOS DATOS DEL REGISTRO QUE DEJO SIN EFECTO UNA SANCION -->
            <div class="modal fade" id="VerFaltaLev">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">DATOS DE MEMORANDUM QUE DEJA SIN EFECTO LA SANCION</h4>
                            <button type="button" class="close" @click="CerrarModal" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <dl>
                                        <dt class="st">NOMBRE:</dt>
                                        <dd class="st">{{AlevSan.nombre}}</dd>
                                    </dl>
                                </div>
                                <div class="col-md-6 separador">
                                    <dl>
                                        <dt class="st"> UNIDAD:</dt>
                                        <dd class="st">{{AlevSan.destino}}</dd>
                                    </dl>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 ">
                                    <dl>
                                        ...
                                        <dd class="st">{{AlevSan.cargo}}</dd>
                                    </dl>
                                </div>
                                <div class="col-md-6 separador">
                                    <dl>
                                        <dt class="st">DOCUMENTO:</dt>
                                        <dd class="st">{{AlevSan.tipodoc}}</dd>
                                    </dl>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <dl>
                                        ...
                                        <dd class="st">{{AlevSan.ndoc}}</dd>
                                    </dl>
                                </div>
                                <div class="col-md-6 separador">
                                    <dl>
                                        <dt class="st">FECHA:</dt>
                                        <dd class="st">{{AlevSan.fecha}}</dd>
                                    </dl>
                                </div>  
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <dl>
                                        ...
                                        <dd class="st">{{AlevSan.descripcion}}</dd>
                                    </dl>
                                </div>
                            </div>
                        </div>
            ...
            <!-- PERMITE VER LOS DATOS DE LA FALTA -->
...
export default {
    data() {
        ...
        return {
            ...
            */
            ...
            cargo: '',
            unidad: '',
            //VARIABLES DE LEVANTAMIENTO DE ARRESTO
            idSan: '',
            nomlev: '',
            cargolev:'',
            doclev: '',
            fechalev: new Date(today.getTime()),
            observacionlev: '',
            ndoclev: '',
            destlev:'',
            //ARRAY DE DATOS DEL DOCUMENTO QUE DEJO SIN EFCTO SANCION
            AlevSan: [],
    ...
    validations: {
        ...
        //levantamiento arresto
        nomlev: {required},
        cargolev: {required, maxLength: maxLength(255)},
        doclev: {required},
        fechalev: {required},
        observacionlev: {required, maxLength: maxLength(500)},
        ndoclev: {required, maxLength: maxLength(10)},
        destlev: {required, maxLength: maxLength(300)},
        validationGroup:['nomlev','cargolev','doclev','ndoclev','fechalev','observacionlev']
    },
    mounted() {
    ...
    methods: {
        ...
        GuardarLev(){
            ...
            if (!this.$v.validationGroup.$invalid) {
                swal.fire({
                    title: '¿Desea dejar sin efecto esta sancion?', // TITULO 
                    ...
                    if (result.value) {
                        ...
                        .post("/levsan", {
                                id: me.idSan,
                                nomlev: me.nomlev.toUpperCase(),
                                carlev: me.cargolev.toUpperCase(),
                                doclev: me.doclev.id,
                                fechalev: me.fechalev,
                                observacionlev: me.observacionlev.toUpperCase(),
                                ndoclev: me.ndoclev,
                                destlev: me.destlev.toUpperCase()
                            })
                            .then(function (response) {
                                $('#LevFalta').modal('hide');
                                me.CerrarModalLev();
                        ...
                        swal.fire(
                            "Anulado", //TITULO
                            "No se realizo la acción.", //TEXTO DE MENSAJE
                ...
                swal.fire({
                    ...
                    if (result.value) {
                        ...
                        .post("/guardarFalta", {
                            ...
                            // complemento: me.dataPer.complemento,
        ...
        /**
         * FUNCION PARA VER DATOS DWE LA FALTA
         */
        VerDatosModal(falta){
            this.VerDatos(falta);
            $('#VerFalta').modal('show');
        ...
        VerDatosLev(falta){
            ...
            .then(function (response) {
                ...
                me.AlevSan = response.data;
                $('#VerFaltaLev').modal('show');
            })
            .catch(function (error) {
                // handle error
                console.log(error);
    ...
    //    window.open('http://sipefab.fab.bo:8000/reporteDemeritos/'+falta);
        ...
        ImprimirRecord(){
            var id = this.per_codigo;
            // window.open('http://sipefabv1.test/reporteRecordDemeritos/'+id);
            window.open('http://sipefab.fab.bo/reporteRecordDemeritos/'+id);
        }

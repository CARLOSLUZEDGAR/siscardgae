                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" :class="{ 'is-invalid' : $v.sancionador.$error, 'is-valid':!$v.sancionador.$invalid }" @keypress="onlyletters" class="form-control" style="text-transform:uppercase;" v-model="sancionador">
                                <div class="invalid-feedback">
                        ...
                        <div class="row p-2 bd-highlight justify-content-center">
                            <div class="col-md-6">
                                ...
                                <input type="text" :class="{ 'is-invalid' : $v.unidad.$error, 'is-valid':!$v.unidad.$invalid }" @keypress="onlyletters" class="form-control" style="text-transform:uppercase;" v-model="unidad">
                                <div class="invalid-feedback">

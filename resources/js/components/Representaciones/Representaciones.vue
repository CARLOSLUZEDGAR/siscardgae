        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">REPRESENTACIONES Y DELEGACIONES</li>
            </ol>
          </div>
        </div>
    ...
    <section class="content">
                     ...
                     <div class="col-md-10 d-flex align-items-center">
                        <div style="" class="col-md-12 d-flex flex-column bd-highlight mb-3">
                            ...
                            <div class="row p-2 bd-highlight justify-content-center">
                                    <div v-if="$auth.can('insert-rep')" class="col-md-4">                                            
                                    ...
                                    <div v-if="$auth.can('report-rep')" class="col-md-4">  
                                        <button type="button" @click="ReporteRepresentacion(datos.codigo)" class="btn btn-sm btn-secondary btn-block">
                                         <i class="far fa-file-pdf"></i>&nbsp;Reporte Personal
                                        </button>
                                    </div>
                                    <div class="col-sm-4">              
                                        <router-link type="button" class="btn btn-danger btn-sm btn-block" :to="'/personalrepresentaciones'" >
                        ...
                        <div class="card-body">
                            <template v-if="representacion.length > 0">
                                <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody>
                                        <tr v-for="s in representacion " :key="s.id">
                                            <td class="text-center">
                                                <!--<button type="button" class="btn btn-success btn-sm" @click="verDatos(p.codigo)">
                                                    <i class="far fa-eye"></i>
                                                </button>-->
                                                <button v-if="$auth.can('edit-rep')" type="button" class="btn btn-warning btn-sm" @click="AbrirEditarRepresentacion(s.codigo)">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                                <button v-if="$auth.can('delete-rep')"  type="button" class="btn btn-danger btn-sm" @click="EliminarRepresentacion(s.codigo)">
                                                    <i class="fas fa-trash-alt"></i>
                                                </button>
                                                
                                                
                                            </td>
                                            <td class="text-center">{{s.representacion}}</td>
                                            ...
                                            <td class="text-center">{{s.observacion}}</td>
      ...
      <!-- /.container-fluid -->
        ...
        <div class="modal fade" data-backdrop="static" id="NuevaRepresentacion">
          ...
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">REGISTRAR NUEVA REPRESENTACION</h4>
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-12">
                        <label for="">REPRESENTACIONES:</label>
                        <v-select                            
                            label="descripcion"                            
                 ...
                 <div class="row">   
                     <div class="col-4">
                        ...
                        <br>
                        <select name="documento" :class="{ 'is-invalid' : $v.documento.$error, 'is-valid':!$v.documento.$invalid }" id="doc" class="form-control" v-model="documento" style="text-transform:uppercase">
                    ...
                    <div class="col-4">
                        ...
                        <div class="invalid-feedback">
                            ...
                            <span v-if="!$v.nrodoc.maxLength">Este campo permite solo 10 caracteres.</span>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="invalid-feedback">
                            ...
                            <span v-if="!$v.descripcion.maxLength">Este campo permite solo 500 caracteres.</span>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <input class="form-control" :class="{ 'is-invalid' : $v.observacion.$error, 'is-valid':!$v.observacion.$invalid }" type="text" style="text-transform:uppercase;" v-model="observacion">
                        <div class="invalid-feedback">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" @click="RegistrarRepresentacion()">Guardar</button>
        ...
        <div class="modal fade"  data-backdrop="static" id="EditarSituacionMilitar">
          ...
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">EDITAR REPRESENTACION</h4>
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <v-select                            
                            label="descripcion"                            
                            :options="representacioncombo"                            
                            v-model="representacionA"
                            :class="{ 'is-invalid' : $v.representacionA.$error, 'is-valid':!$v.representacionC.$invalid }"
                        ...
                        <div class="invalid-feedback">
                            <span v-if="!$v.representacionA.required">Este campo es Requerido</span>
                        </div>
                ...
                <div class="row">
                    <div class="col-4">
                        <label for="">DOCUMENTO:</label>
                        <select name="documentoA" id="docA" :class="{ 'is-invalid' : $v.documentoA.$error, 'is-valid':!$v.documentoA.$invalid }" class="form-control" v-model="documentoA" style="text-transform:uppercase">
                            <option value="MEMORANDUM" selected>MEMORANDUM</option>
                            <option value="ORDEN DEL DIA">ORDEN DEL DIA</option>
                        </select>
                        <div class="invalid-feedback">
                            <span v-if="!$v.documentoA.required">Este campo es Requerido</span>
                        </div>
                        <!--<input class="form-control" style="text-transform:uppercase;" type="text" v-model="documentoA">-->
                    </div>
                    <div class="col-4">
                        <label for="">NRO DOCUMENTO:</label>
                        <input class="form-control" :class="{ 'is-invalid' : $v.nrodocA.$error, 'is-valid':!$v.nrodocA.$invalid }" type="text" style="text-transform:uppercase;" v-model="nrodocA">
                        <div class="invalid-feedback">
                            <span v-if="!$v.nrodocA.required">Este campo es Requerido</span>
                            <span v-if="!$v.nrodocA.maxLength">Este campo permite solo 10 caracteres.</span>
                        </div>
                        
                    </div>
                    <div class="col-4">
                        <label for="">FECHA:</label>
                        <input class="form-control" :class="{ 'is-invalid' : $v.fechaA.$error, 'is-valid':!$v.fechaA.$invalid }"  type="date" v-model="fechaA">
                        <div class="invalid-feedback">
                            <span v-if="!$v.fechaA.required">Este campo es Requerido</span>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-12">
                        <label for="">DESCRIPCION:</label>
                        <input class="form-control" :class="{ 'is-invalid' : $v.descripcionA.$error, 'is-valid':!$v.descripcionA.$invalid }" type="text" style="text-transform:uppercase;" v-model="descripcionA">
                        <div class="invalid-feedback">
                            <span v-if="!$v.descripcionA.required">Este campo es Requerido</span>
                            <span v-if="!$v.descripcionA.maxLength">Este campo permite solo 500 caracteres.</span>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <label for="">OBSERVACION:</label>
                        <input class="form-control" :class="{ 'is-invalid' : $v.observacionA.$error, 'is-valid':!$v.observacionA.$invalid }" type="text" style="text-transform:uppercase;" v-model="observacionA">
                        <div class="invalid-feedback">
                            <span v-if="!$v.observacionA.required">Este campo es Requerido</span>
                            <span v-if="!$v.observacionA.maxLength">Este campo permite solo 500 caracteres.</span>
                        </div>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-primary" @click="EditarRepresentacion()">Editar</button>
              <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
...
export default {
    ...
    validations: {
        ...
        documento: {required},
        nrodoc: {required, maxLength: maxLength(10)},
        fecha: {required},
        descripcion: {required, maxLength: maxLength(500)},
        observacion: {required, maxLength: maxLength(500)},
        representacionA: {required},
        documentoA: {required},
        nrodocA: {required, maxLength: maxLength(10)},
        fechaA: {required},
        descripcionA: {required, maxLength: maxLength(500)},
        observacionA: {required, maxLength: maxLength(500)},
        validationGroup: ['representacionC','documento', 'nrodoc', 'fecha','descripcion','observacion'],
        validationGroupEdit: ['representacionA','documentoA', 'nrodocA', 'fechaA','descripcionA','observacionA'],
      
    },
    mounted() {
        this.listarRepresentacion();
    ...
    methods: {
        ...
        cambiarPagina(page){
                ...
                me.listarRepresentacion(page);
            },

        listarRepresentacion(page){
            let me = this;
            console.log(me.percod);
            axios
            .post("/listarRepresentacion", {
                percodigo: me.percod,
                page: page
            })
            .then(function (response) {
                ...
                if (response.data.code == "200") {
                    me.representacion = response.data.datos.data;
        ...
        listarRepresentacionesCombo(){
            let me = this;
            axios
            .get('/listarRepresentacionesCombo')
            .then(function (response) {
        ...
        NuevaRepresentacion(){
            this.listarRepresentacionesCombo();
        ...
        RegistrarRepresentacion(){
            ...
            if (!this.$v.validationGroup.$invalid) {
                swal.fire({
                    title: '¿Desea guardar la nueva Representación?', // TITULO 
                    ...
                    axios
                    .post("/registrarRepresentacion", {
                            percodigo: me.percod,
                            reprecod: me.representacionC.id,
                        ...
                        .then(function (response) {
                            ...
                            me.listarRepresentacion();
                            me.listarDatosPersonalSituacion();
                            $('#NuevaRepresentacion').modal('hide');
                            swal.fire(
                                "Aceptado", //TITULO
                                "Se añadio correctamente la nueva Representación.", //TEXTO DE MENSAJE
                        ...
                        swal.fire(
                            "Anulado", //TITULO
                            "No se realizo el registro de la nueva Representación.", //TEXTO DE MENSAJE
        ...
        AbrirEditarRepresentacion(s){
            let me = this;
            me.idrepre = s;
            axios
            .post("/listarRepresentacionModificar", {
                reppercod: s
            })
            .then(function (response) {
                
                
                me.representacionA = response.data.nomrep;
                me.idrepC = response.data.reprecod;
                ...
                me.listarRepresentacionesCombo();
        ...
        EditarRepresentacion(){
            ...
            if (!this.$v.validationGroupEdit.$invalid) {
                swal.fire({
                    title: '¿Desea realizar la modificación de la Representación ?', // TITULO 
                    icon: 'question', //ICONO (success, warnning, error, info, question)
                    showCancelButton: true, //HABILITACION DEL BOTON CANCELAR
                    confirmButtonColor: 'info', // COLOR DEL BOTON PARA CONFIRMAR
                    cancelButtonColor: '#868077', // CLOR DEL BOTON CANCELAR
                    ...
                    if (result.value) {
                        let me = this;
                        if (me.representacionA.id) {
                            var repre = me.representacionA.id;
                        } else {
                            var repre =  me.idrepC;
                        }
                        axios
                        .post("/editarRepresentacion", {
                            codigo:me.idrepre,
                            reprecod: repre,
                        ...
                        .then(function (response) {
                            ...
                            swal.fire(
                                "Aceptado", //TITULO
                                "Se modificó correctamente la Representación.", //TEXTO DE MENSAJE
                                "success" // TIPO DE MODAL (success, warnning, error, info)
                            )
                            me.listarRepresentacion();
                            me.listarDatosPersonalSituacion();
                        ...
                        swal.fire(
                        "Anulado", //TITULO
                        "No se realizo la actualización de la Representación.", //TEXTO DE MENSAJE
                        "info" // TIPO DE MODAL (success, warnning, error, info)
                        );
                    }
                })
        ...
        EliminarRepresentacion(codigo){
            swal.fire({
                title: '¿Desea realizar la eliminación de la Representación ?', // TITULO 
                icon: 'question', //ICONO (success, warnning, error, info, question)
                showCancelButton: true, //HABILITACION DEL BOTON CANCELAR
                confirmButtonColor: 'info', // COLOR DEL BOTON PARA CONFIRMAR
                cancelButtonColor: '#868077', // CLOR DEL BOTON CANCELAR
                ...
                let me = this;
                    ...
                    .then(function (response) {
                        ...
                        swal.fire(
                            "Aceptado", //TITULO
                            "Se eliminó correctamente la Representación.", //TEXTO DE MENSAJE
                            "success" // TIPO DE MODAL (success, warnning, error, info)
                        )
                        me.listarRepresentacion();
                        me.listarDatosPersonalSituacion();
                    ...
                    .catch(function (error) {
                        ...
                        console.log(error);
                            ...
                            swal.fire(
                            "Anulado", //TITULO
                            "No se realizo la eliminación de la Representación.", //TEXTO DE MENSAJE
                            "info" // TIPO DE MODAL (success, warnning, error, info)
                            );
                        }
                    })
        ...
        ReporteRepresentacion(codigo){
            window.open('http://sipefab.fab.bo/RepresentacionesPdf?per_codigo='+codigo);
        },
        /**

        ...
        <div class="row mb-2">
          <div class="col-sm-8">    
              <div class="row">
                  <h1>
                    ...
                    REPRESENTACIONES Y DELEGACIONES DEL PERSONAL
                </h1>&nbsp;
          ...
          <div class="col-sm-4">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">REPRESENTACIONES Y DELAGACIONES</li>
            </ol>
          </div>
        </div>
      </div>
                        ...
                        <div class="row  d-flex justify-content-left">
                            <div class="col-md-8 ">
                                    <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" style="text-transform:uppercase;" v-model="buscar" @keyup="BuscarPersona()">
                                    ...
                                    <tbody>
                                        <tr v-for="p in listaPersonal"> 
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button type="button" class="btn btn-success btn-sm" @click="VerRepresentaciones(p.per_codigo)">
